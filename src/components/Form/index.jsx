    ...
    return(
        <StyledForm onSubmit={(event)=>formSubmit(event)}>
            <FormInput 
                ...
                placeholder="Insira o review do jogo"
                handleChange={(value) => setGameTitle(value)}
            />
            <FormSelect 
                color={method ? '#6BD1FF' : '#696969'}
                label="Sistema ou console"
                id="system"
            ...
            <FormInput
                ...
                placeholder="Insira o link da imagem com a capa do vídeo"
            ...
            <FormInput 
                ...
                placeholder="Insira o link do review do jogo"
            ...
            <FormTextArea  
                ...
                placeholder="Insira a descrição do jogo ou review"
